...
<div>
    ...
    <div class="container registro">
        <div class="row">
            <div class="col-md-12">
                <h2 style="text-align: center;">Modifique la Información del Usuario</h2>
            </div>
        </div>
        <?php
        ...
        <div class="row ingredientes">
            <div class="col-md-12">
                <form method="POST" action="RevisionUsuAdmin.php?id_usuario=<?php echo($id_usuario )?>" enctype="multipart/form-data" autocomplete="off">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="nombre">Nombre</label>
                                    <input type="text" class="form-control" name="nombre" id="name"  required value="<?php echo "$nom"; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="usuario" id="usu" placeholder="Usuario" required value="<?php echo "$usu" ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="correos" id="Correo" placeholder="Correo" required value="<?php echo "$corr" ?>">
                                </div>
                            </div>
                        </div>
                    <br><button type="submit" class="btn btn-primary">Editar Usuario</button>
                </form>
            </div>
        </div>
    </div>
