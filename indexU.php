...
/* Images used */
.img1 { background-image: url("img/Puebla1.jpg"); }
.img2 { background-image: url("img/Puebla2.jpg"); }
.img3 { background-image: url("img/Puebla3.jpg"); }
.img4 { background-image: url("img/Puebla4.jpg"); }
...
<!--https://bootsnipp.com/snippets/featured/fancy-navbar-login-sign-in-form-->
    ...
    <div class="bg-text">¡Hola <?php echo ($_SESSION['username']); ?>!</div>
