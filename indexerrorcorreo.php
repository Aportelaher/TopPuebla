...
<body onload="document.getElementById('email').value = ''; document.getElementById('pass').value = ''">
    <!-- Top menu -->
...
<!--https://bootsnipp.com/snippets/featured/fancy-navbar-login-sign-in-form-->
    ...
    <div id="captioned-gallery">
            <figure class="slider">
                ...
                <figure>
                    <img class="mySlides" src="img/Puebla5.jpg" style="width:100%">
                    <figcaption>Container City - Cholula</figcaption>
                </figure>

                <figure>
                    <img class="mySlides" src="img/Puebla6.jpg" style="width:100%">
                    <figcaption>Centro Expositor - Fuertes de Loreto y Guadalupe </figcaption>
                </figure>

                <figure>
                    <img class="mySlides" src="img/Puebla9.jpg" style="width:100%">
                    <figcaption>Museo del Ferrocarril - Centro Histórico </figcaption>
                </figure>

                <figure>
                    <img class="mySlides" src="img/Puebla8.jpg" style="width:100%">
                    <figcaption> Centro Expositor (Dentro)</figcaption>
                </figure>
                
                <figure>
                    <img class="mySlides" src="img/Puebla7.png" style="width:100%">
                    <figcaption>Fuertes de Loreto y Guadalupe </figcaption>
                </figure>
